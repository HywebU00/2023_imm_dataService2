...
(function(factory) {
    ...
    Slick = (function() {
        ...
        function Slick(element, settings) {
            ...
            _.defaults = { //可以視情況加入
                ...
                prevArrow: '<button type="button" data-role="none" class="slick-prev" aria-label="previous" title="前一則">Previous</button>', //Allows you to select a node or customize the HTML for the "Previous" arrow.				
                nextArrow: '<button type="button" data-role="none" class="slick-next" aria-label="next" title="下一則">Next</button>', //Allows you to select a node or customize the HTML for the "Next" arrow.
                autoplay: false, //自動播放
                ...
                pauseOnDotsHover: true, //Pause Autoplay when a dot is hovered 滑鼠移過圓點後暫停自動撥放
    ...
    Slick.prototype.initDotEvents = function() {
		...
		if (_.options.dots === true && _.options.pauseOnDotsFocus === true && _.options.autoplay === true) {
            $('li', _.$dots)
                .on('focusin.slick', function(){
                    _.paused = true;
                    _.autoPlayClear();
                })
                .on('focusout.slick', function(){
                    _.paused = false;
                    _.autoPlay();
                });
        }
